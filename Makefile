IDIR = ../include
CC = g++
CFLAGS = -I$(IDIR) -std=c++20 -O3 -flto=auto -static #-mavx2 -mfma -static #-ffast-math #-march=native #-fopenmp #-Wpedantic
LFLAGS = -O3 -flto=auto -static #-mavx2 -mfma -static #-ffast-math #-march=nativ #-fopenmp
